...
/*
** RVV (RISC-V Vector Extension) 1.0 implementation -- classifies 32
** characters via vsetvl_e8m1(32) and vector predicate ops.  Works
** with any VLEN; the hardware vector length affects throughput but
