...
** source file "bench/rust_compare/json.lime".
*/
/*
** 2000-05-29
**
...
#line 30 "bench/rust_compare/json.c"
...
**                       token.
**    JsonParseTOKENTYPE     is the data type used for minor type for terminal
...
**                       which is JsonParseTOKENTYPE.  The entry in the union
**                       for terminal symbols is called "yy0".
**    YYSTACKDEPTH       is the maximum depth of the parser's stack.  If
**                       zero the stack is dynamically sized using realloc()
**    JsonParseARG_SDECL     A static variable declaration for the %extra_argument
**    JsonParseARG_PDECL     A parameter declaration for the %extra_argument
**    JsonParseARG_PARAM     Code to pass %extra_argument as a subroutine parameter
**    JsonParseARG_STORE     Code to store %extra_argument into yypParser
**    JsonParseARG_FETCH     Code to extract %extra_argument from yypParser
**    JsonParseCTX_*         As JsonParseARG_ except for %extra_context
...
#define YYFIRSTTOKEN 257
#define YYNRHS_MAX 3
#define JsonParseTOKENTYPE void*
typedef union {
  int yyinit;
  JsonParseTOKENTYPE yy0;
} YYMINORTYPE;
#ifndef YYSTACKDEPTH
#define YYSTACKDEPTH 100
#endif
#define JsonParseARG_SDECL
#define JsonParseARG_PDECL
#define JsonParseARG_PARAM
#define JsonParseARG_FETCH
#define JsonParseARG_STORE
#undef YYREALLOC
...
#define YYDYNSTACK 0
#undef YYSIZELIMIT
#define JsonParseCTX(P) 0
#define JsonParseCTX_SDECL
#define JsonParseCTX_PDECL
#define JsonParseCTX_PARAM
#define JsonParseCTX_FETCH
#define JsonParseCTX_STORE
#undef YYERRORSYMBOL
#undef YYERRSYMDT
#undef YYFALLBACK
#define YYNSTATE             10
...
#define YY_MAX_SHIFTREDUCE   42
#define YY_ERROR_ACTION      43
#define YY_ACCEPT_ACTION     44
#define YY_NO_ACTION         45
...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */    57,    4,   45,    1,   39,    7,    7,   29,   30,   31,
 /*    10 */    32,   33,    4,    8,    1,   62,   62,   62,   29,   30,
 /*    20 */    31,   32,   33,    3,   44,    9,    9,    9,    6,    6,
 /*    30 */     6,   46,   34,    6,   58,   58,   58,    8,   40,   35,
 /*    40 */     2,   45,   45,    5,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */    17,    1,   19,    3,    4,   16,   17,    7,    8,    9,
 /*    10 */    10,   11,    1,    7,    3,   13,   14,   15,    7,    8,
 /*    20 */     9,   10,   11,    5,   12,   13,   14,   15,   13,   14,
 /*    30 */    15,    0,    2,   18,   13,   14,   15,    7,    4,    2,
 /*    40 */     6,   19,   19,    6,   19,   19,   19,   19,   19,   19,
 /*    50 */    19,   19,   12,   12,   12,   12,
};
#define YY_SHIFT_COUNT    (9)
#define YY_SHIFT_MIN      (0)
#define YY_SHIFT_MAX      (37)
static const unsigned char yy_shift_ofst[] = {
 /*     0 */    11,    0,   11,   11,   30,    6,   34,   37,   18,   31,
};
...
struct yyParser {
  ...
  ** at each JsonParseLoc() entry so that %syntax_error sees the location
...
#endif
  /* Action-time lookahead access (P0-NEW-5).  While JsonParse() runs a
  ...
  ** action code can read them via JsonParse_get_lookahead() and
  ** optionally signal consumption via JsonParse_clear_lookahead().  This
  ...
  **
  ** yyLookaheadMajor is YYEMPTY (-2) when no JsonParse() call is in
  ** progress.  yyLookaheadCleared is set by JsonParse_clear_lookahead()
  ...
  ** treating the lookahead as consumed by the action body. */
  ...
  JsonParseTOKENTYPE yyLookaheadMinor;
  char yyLookaheadCleared;
  JsonParseARG_SDECL                /* A place to hold %extra_argument */
  JsonParseCTX_SDECL                /* A place to hold %extra_context */
...
** None.
*/
void JsonParseTrace(FILE *TraceFILE, char *zTracePrompt){
...
** JsonParseTokenName, JsonParseExpectedTokens, JsonParseExpectedTokensString,
...
static const char *const yyRuleName[] = {
 ...
 /*   6 */ "value ::= FALSE",
 /*   7 */ "value ::= NULL",
 /*   8 */ "object ::= LBRACE RBRACE",
 /*   9 */ "object ::= LBRACE members RBRACE",
 /*  10 */ "members ::= pair",
 /*  11 */ "members ::= members COMMA pair",
 /*  12 */ "pair ::= STRING COLON value",
 /*  13 */ "array ::= LBRACKET RBRACKET",
 /*  14 */ "array ::= LBRACKET elements RBRACKET",
 /*  15 */ "elements ::= value",
 /*  16 */ "elements ::= elements COMMA value",
};
#endif /* NDEBUG */
...
static int yyGrowStack(yyParser *p){
  ...
  yyStackEntry *pNew;
#ifdef YYSIZELIMIT
  int nLimit = YYSIZELIMIT(JsonParseCTX(p));
#endif
  ...
  if( p->yystack==p->yystk0 ){
    pNew = YYREALLOC(0, newSize*sizeof(pNew[0]), JsonParseCTX(p));
    if( pNew==0 ) return 1;
    memcpy(pNew, p->yystack, oldSize*sizeof(pNew[0]));
  }else{
    pNew = YYREALLOC(p->yystack, newSize*sizeof(pNew[0]), JsonParseCTX(p));
    if( pNew==0 ) return 1;
  }
  p->yystack = pNew;
...
** second argument to JsonParseAlloc() below.  This can be changed by
...
*/
void JsonParseInit(void *yypRawParser JsonParseCTX_PDECL){
  ...
  ** sees a defined value if it fires before the first JsonParseLoc() call,
  ** or in pull-parser mode (JsonParse() without JsonParseLoc()). */
  ...
  ** as a sentinel for "no JsonParse() call in progress". */
...
#ifndef JsonParse_ENGINEALWAYSONSTACK
/* 
...
** to JsonParse and JsonParseFree.
*/
void *JsonParseAlloc(void *(*mallocProc)(YYMALLOCARGTYPE) JsonParseCTX_PDECL){
  yyParser *yypParser;
  yypParser = (yyParser*)(*mallocProc)( (YYMALLOCARGTYPE)sizeof(yyParser) );
  if( yypParser ){
    JsonParseCTX_STORE
    JsonParseInit(yypParser JsonParseCTX_PARAM);
  }
  return (void*)yypParser;
}
#endif /* JsonParse_ENGINEALWAYSONSTACK */
...
void JsonParseFinalize(void *p){
  ...
  ** element left in the stack */
  ...
  if( pParser->yystack!=pParser->yystk0 ){
    YYFREE(pParser->yystack, JsonParseCTX(pParser));
  }
#endif
}
...
*/
#if defined(YYCOVERAGE)
int JsonParseCoverage(FILE *out){
...
/******** End %stack_overflow code ********************************************/
   JsonParseARG_STORE /* Suppress warning about unused %extra_argument var */
   JsonParseCTX_STORE
}
...
static void yy_shift(
  ...
  JsonParseTOKENTYPE yyMinor        /* The minor token to shift in */
){
  yyStackEntry *yytos;
  yypParser->yytos++;
#ifdef YYTRACKMAXSTACKDEPTH
...
static const YYCODETYPE yyRuleInfoLhs[] = {
    ...
    13,  /* (6) value ::= FALSE */
    13,  /* (7) value ::= NULL */
    14,  /* (8) object ::= LBRACE RBRACE */
    14,  /* (9) object ::= LBRACE members RBRACE */
    16,  /* (10) members ::= pair */
    16,  /* (11) members ::= members COMMA pair */
    17,  /* (12) pair ::= STRING COLON value */
    15,  /* (13) array ::= LBRACKET RBRACKET */
    15,  /* (14) array ::= LBRACKET elements RBRACKET */
    18,  /* (15) elements ::= value */
    18,  /* (16) elements ::= elements COMMA value */
};
...
static const signed char yyRuleInfoNRhs[] = {
   ...
   -1,  /* (6) value ::= FALSE */
   -1,  /* (7) value ::= NULL */
   -2,  /* (8) object ::= LBRACE RBRACE */
   -3,  /* (9) object ::= LBRACE members RBRACE */
   -1,  /* (10) members ::= pair */
   -3,  /* (11) members ::= members COMMA pair */
   -3,  /* (12) pair ::= STRING COLON value */
   -2,  /* (13) array ::= LBRACKET RBRACKET */
   -3,  /* (14) array ::= LBRACKET elements RBRACKET */
   -1,  /* (15) elements ::= value */
   -3,  /* (16) elements ::= elements COMMA value */
};

static void yy_accept(yyParser*);  /* Forward Declaration */

/* Forward declarations for the action-time lookahead API
** (JsonParse_get_lookahead / JsonParse_clear_lookahead).  The definitions
** live just before void JsonParse() further down; these forward
** declarations let user action bodies inside yy_reduce reference
** the API without an out-of-order-symbol error.  P0-NEW-5. */
#ifndef YYEMPTY
# define YYEMPTY (-2)
#endif
int  JsonParse_get_lookahead(
  void *yyp,
  JsonParseTOKENTYPE *yyminor_out
#ifdef YYLOCATIONTYPE
  , YYLOCATIONTYPE *yyloc_out
#endif
);
void JsonParse_clear_lookahead(void *yyp);

/* P0-NEW-8: opt-in eager default-reduce drain.  After a JsonParse()
...
** reduction.  JsonParse_drain forces the eager-fire behavior on demand,
...
** drain see no lookahead (JsonParse_get_lookahead returns YYEMPTY).
** Safe to call between JsonParse() invocations; safe to call multiple
** times in a row (the second call is a no-op once the parser is
** quiescent). */
void JsonParse_drain(void *yyp JsonParseCTX_PDECL);
...
** changes shape but the runtime ABI (JsonParserSnapshot, the
...
typedef struct yy_reduce_ctx {
  ...
  JsonParseTOKENTYPE yyLookaheadToken; /* Value of the lookahead token */
#ifdef YYLOCATIONTYPE
...
static void yy_rule_1(yy_reduce_ctx *yy_ctx){
  (void)yy_ctx;
  /* (1) OPTIMIZED OUT */
  assert(0 && "yy_rule_1: optimized-out rule reached");
}
...
static void yy_rule_2(yy_reduce_ctx *yy_ctx){
  (void)yy_ctx;
  /* (2) OPTIMIZED OUT */
  assert(0 && "yy_rule_2: optimized-out rule reached");
}
...
static void yy_rule_10(yy_reduce_ctx *yy_ctx){
  (void)yy_ctx;
  /* (10) OPTIMIZED OUT */
  assert(0 && "yy_rule_10: optimized-out rule reached");
}
...
static void yy_rule_15(yy_reduce_ctx *yy_ctx){
  (void)yy_ctx;
  /* (15) OPTIMIZED OUT */
  assert(0 && "yy_rule_15: optimized-out rule reached");
}
...
static void (*const yy_rule_reduce_fn[])(yy_reduce_ctx *) = {
  yy_rule_0,  /* (0) root ::= value */
  yy_rule_1,  /* (1) value ::= object */
  yy_rule_2,  /* (2) value ::= array */
  yy_rule_3,  /* (3) value ::= STRING */
  yy_rule_4,  /* (4) value ::= NUMBER */
  yy_rule_5,  /* (5) value ::= TRUE */
  yy_rule_6,  /* (6) value ::= FALSE */
  yy_rule_7,  /* (7) value ::= NULL */
  yy_rule_8,  /* (8) object ::= LBRACE RBRACE */
  yy_rule_9,  /* (9) object ::= LBRACE members RBRACE */
  yy_rule_10,  /* (10) members ::= pair */
  yy_rule_11,  /* (11) members ::= members COMMA pair */
  yy_rule_12,  /* (12) pair ::= STRING COLON value */
  yy_rule_13,  /* (13) array ::= LBRACKET RBRACKET */
  yy_rule_14,  /* (14) array ::= LBRACKET elements RBRACKET */
  yy_rule_15,  /* (15) elements ::= value */
  yy_rule_16,  /* (16) elements ::= elements COMMA value */
};
...
static YYACTIONTYPE yy_reduce(
  ...
  JsonParseTOKENTYPE yyLookaheadToken  /* Value of the lookahead token */
  JsonParseCTX_PDECL                   /* %extra_context */
){
...
/************ End %parse_failure code *****************************************/
  JsonParseARG_STORE /* Suppress warning about unused %extra_argument variable */
  JsonParseCTX_STORE
}
...
**   yyminor   -- token value (JsonParseTOKENTYPE) of the offending
...
**                JsonParseLoc().  Also available as the macro TOKEN_LOC.
...
static void yy_syntax_error(
  ...
  JsonParseTOKENTYPE yyminor         /* The minor type of the error token */
#ifdef YYLOCATIONTYPE
...
** "JsonParseAlloc" which describes the current state of the parser.
...
** not of the stack-top symbol.  JsonParseLoc() stashes the lookahead's
...
**
** When the pull-parser entry point JsonParse() is used (no location
** threading), or when a syntax error fires before the first JsonParseLoc()
...
**
** JsonParse_get_lookahead() returns the externally-visible token code
** the parser is about to shift -- the same value the caller passed
** to JsonParse() / JsonParseLoc() and the same value the user-emitted
** #defines compare against.  Returns YYEMPTY (-2) if no JsonParse() call
...
** ignored.
**
** JsonParse_clear_lookahead() tells the dispatch loop the action body
** consumed the lookahead via JsonParse_get_lookahead() and pulled
** further tokens from the lexer itself.  The current JsonParse() call
** returns without shifting.  The driver's next JsonParse() call provides
** whatever the lexer has advanced to, treated as a fresh lookahead.
*/
int JsonParse_get_lookahead(
  void *yyp,                          /* The parser */
  JsonParseTOKENTYPE *yyminor_out         /* (out) Token value, or NULL */
#ifdef YYLOCATIONTYPE
...
void JsonParse_drain(void *yyp JsonParseCTX_PDECL){
  ...
  for(;;){
    ...
    ** so the next JsonParse() call would re-enter the dispatch loop
    ...
    ** semantics the caller asked for. */
    if( state >= YY_MIN_REDUCE && state <= YY_MAX_REDUCE ){
      ...
      yy_reduce(yypParser, ruleno, YYNOCODE, dummy_tok JsonParseCTX_PARAM);
      continue;
    }
...
void JsonParse(
  ...
  JsonParseTOKENTYPE yyminor       /* The value for the token */
  JsonParseARG_PDECL               /* Optional %extra_argument parameter */
){
  ...
  ** JsonParse_get_lookahead().  Done before the %first_token range
  ...
  while(1){ /* Exit by "break" */
    ...
    if( yyact >= YY_MIN_REDUCE ){
      ...
      ** enough on the stack to push the LHS value */
      ...
      yyact = yy_reduce(yypParser,yyruleno,yymajor,yyminor JsonParseCTX_PARAM);
      /* If the reduce action called JsonParse_clear_lookahead() the user
      ** action consumed the token via JsonParse_get_lookahead() and read
      ** further tokens from the lexer themselves.  Skip the rest of
      ** the dispatch (no shift) and return.  The driver's next
      ** JsonParse() call provides whatever the lexer has advanced to.
      ** P0-NEW-5. */
      ...
      */
      if( yypParser->yyerrcnt<0 ){
        ...
        ** caller passed to JsonParse(); user %syntax_error code expects to
...
#endif
  /* Clear action-time lookahead state on JsonParse() exit (P0-NEW-5).
  ** Calls to JsonParse_get_lookahead() outside an active JsonParse() are
...
#ifdef YYLOCATIONTYPE
/*
** Location-aware version of JsonParse().
** Same as JsonParse() but also stores the source location for the shifted token.
...
void JsonParseLoc(
  ...
  ** previously-shifted token's location). */
  ...
  JsonParse(yyp, yymajor, yyminor JsonParseARG_PARAM);
  /* After JsonParse shifts the token, patch the location on top of stack */
...
*/
int JsonParseFallback(int iToken){
#ifdef YYFALLBACK
...
**
** See also JsonParseExpectedTokens() for a structured (array) form and
** JsonParseTokenName() for looking up individual token names.
*/
char *JsonParseExpectedTokensString(void *yyp){
  yyParser *yypParser = (yyParser*)yyp;
...
**
**    JsonParseTokenName(code)      -> string name for a token code
**    JsonParseState(parser)        -> current parser state number
**    JsonParseExpectedTokens(...)  -> array of token codes valid at a state
**
...
*/
const char *JsonParseTokenName(int tokenCode){
...
**
** The returned codes can be passed to JsonParseTokenName() to obtain
** human-readable names.  Codes are returned in ascending numeric
** order.
**
** Typical usage from a %syntax_error callback:
**
**   int s = JsonParseState(yypParser);
**   int n = JsonParseExpectedTokens(s, NULL, 0);
**   int *codes = malloc(n * sizeof(int));
**   JsonParseExpectedTokens(s, codes, n);
**   for( int i = 0; i < n; i++ ){
**       fprintf(stderr, "  expected: %s\n", JsonParseTokenName(codes[i]));
**   }
**   free(codes);
*/
int JsonParseExpectedTokens(int stateno, int *out, int max){
  int count = 0;
  int i;
